...
import { Star, Calendar, Users, Radio, Award, Clock, Info, User, Film } from 'lucide-react';
  ...
  return (
    ...
    >
      <Tabs defaultValue="about" className="w-full">
        <TabsList className="grid grid-cols-2 mb-8 bg-gray-800/50 rounded-xl p-1 max-w-md mx-auto">
          <TabsTrigger 
            value="about"
        ...
        <TabsContent value="about">
          ...
          >
            {/* Sinopse */}
            <Card className="border-gray-700/30 bg-gray-800/20 backdrop-blur-sm overflow-hidden shadow-xl">
              <CardContent className="p-6">
                <motion.div variants={itemAnimation} className="mb-6">
                  <h3 className="text-2xl font-bold mb-4 flex items-center text-white">
                    ...
                    <Info className="mr-2 text-red-400" size={20} />
                    Sinopse
                  </h3>
                ...
                <motion.div variants={itemAnimation} className="mb-6">
                  <h3 className="text-xl font-bold mb-4 flex items-center text-white">
                    ...
                    <Film className="mr-2 text-red-400" size={18} />
                    Categorias
                  </h3>
                  <motion.div 
              ...
              <CardContent className="p-6">
                <motion.div variants={itemAnimation}>
                  <h3 className="text-xl font-bold mb-5 flex items-center text-white">
                    <span className="w-1 h-6 bg-red-500 mr-3 rounded-full"></span>
                    <Award className="mr-2 text-red-400" size={18} />
                    Detalhes da série
                  </h3>
                  
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <motion.div 
                      className="flex items-start gap-4 bg-gray-800/40 p-4 rounded-xl border border-gray-700/30"
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {tvshow.cast.map((actor, index) => (
                      <motion.div
                        key={actor}
                        className="flex items-center gap-4 bg-gray-800/40 p-4 rounded-xl border border-gray-700/30 hover:border-red-500/30 transition-all"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ 
                          opacity: 1, 
                          y: 0,
                      ...
                      >
                        <div className="h-14 w-14 rounded-full bg-gradient-to-br from-red-600/30 to-gray-800 flex items-center justify-center text-lg font-medium text-white shadow-lg">
            ...
            <Card className="border-gray-700/30 bg-gray-800/20 backdrop-blur-sm overflow-hidden shadow-xl">
              <CardContent className="p-6">
                ...
                >
                  ...
                  <motion.div 
                    className="flex items-start gap-4 bg-gray-800/40 p-6 rounded-2xl border border-gray-700/30"
                    whileHover={{ 
                      boxShadow: "0 8px 30px rgba(255, 0, 0, 0.1)",
                  ...
                  >
                    <div className="p-3 bg-gray-900/60 backdrop-blur-sm rounded-xl shadow-inner">
                      <Award className="h-6 w-6 text-yellow-400" />
                    </div>
                    <div>
                      <h4 className="text-gray-400 text-sm font-medium mb-1">Criador:</h4>
